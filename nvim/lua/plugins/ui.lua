return {
  {
    ...
    opts = function(_, opts)
      ...
      opts.highlights = {
        ...
        tab_separator_selected = { bg = "none", fg = p.teal_bright },
        ...
        error = { bg = "none", fg = p.diagnostic_error },
        error_visible = { bg = "none", fg = p.diagnostic_error },
        error_selected = { bg = "none", fg = p.diagnostic_error },
        warning = { bg = "none", fg = p.diagnostic_warn },
        warning_visible = { bg = "none", fg = p.diagnostic_warn },
        warning_selected = { bg = "none", fg = p.diagnostic_warn },
        hint = { bg = "none", fg = p.diagnostic_hint },
        hint_visible = { bg = "none", fg = p.diagnostic_hint },
        hint_selected = { bg = "none", fg = p.diagnostic_hint },
        info = { bg = "none", fg = p.diagnostic_info },
        info_visible = { bg = "none", fg = p.diagnostic_info },
        info_selected = { bg = "none", fg = p.diagnostic_info },
        pick = { bg = "none", fg = p.ui_accent_fg, bold = true },
        pick_visible = { bg = "none", fg = p.ui_accent_fg, bold = true },
        pick_selected = { bg = "none", fg = p.ui_accent_fg, bold = true },
